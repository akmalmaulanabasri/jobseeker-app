    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                {{-- <img src="https://upload.wikimedia.org/wikipedia/commons/2/2d/JobStreet_logo.svg" alt="JobStreet"
                    height="30"> --}}
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('cari-lowongan') }}">Cari
                            lowongan</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Sumber daya karir</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex">
                    ...
                    @else
                        <a class="btn btn-light fs-5" href="{{ route('login') }}">Login</a>
                    @endif
                </div>
            </div>
        </div>
